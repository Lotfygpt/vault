    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black via-[#0a0a0a] to-[#1a1a1a] text-[#C8A951] px-5">
      ...
      >
        ...
        <motion.div
          ...
          className="relative flex items-center justify-center w-[100px] h-[100px] mb-5"
        >
          <Image
            src="/images/logo.png"
            alt="LXV Vault"
            width={100}
            height={100}
            className="object-contain drop-shadow-[0_0_30px_rgba(200,169,81,0.5)]"
          />
        </motion.div>
        ...
        {/* Description */}
        <div className="text-[#e1c983]/85 text-[0.9rem] leading-relaxed mb-8 space-y-3 max-w-[340px]">
          <p>
          ...
          <p>
            ...
            <span className="text-[#f9e27b]"> Rolex, Audemars Piguet, Patek Philippe, Hermès, Dior</span> et bien d’autres.
          </p>
        </div>
